...
const cardsData = [
    { id: 1, frontIcon: "❤️", text: "بحبك", backContent: "أنت أجمل حاجة حصلتلي", color: "from-pink-500" },
    { id: 2, frontIcon: "✨", text: "بموت فيك", backContent: "ضحكتك هي السبب اللي بيخليني أبتسم كل يوم", color: "from-purple-500" },
